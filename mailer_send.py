...
senderemail_id = str(input("Enter your Email ID: "))
senderpassword = str(getpass.getpass("Enter your Password: ")) # Hide password while typing.
# Request login of the sender.
try:
    print("Logging in:",senderemail_id,"...")
